...
levels.push(new Level(8, 'res/bg/8.jpg', 'ZOINKS! That roar belongs to a DINOSAUR!! WHAT DO YOU DO?!?', 'Alive', '(left) RUN FOR YOUR LIFE!! DUH!! | (right) Just sloooooooowly walk around. Keep quiet and the dinos won’t know you’re here, right?', 9, 10, canvas));
...
levels.push(new Level(10, 'res/bg/10.jpg', 'Dang it. You fell into a lava moat.', 'DEAD', 'That’s okay, you could always refresh to try again.', 1, 1, canvas));
...
levels.push(new Level(12, 'res/bg/12.jpg', 'You spot a cub in danger! What do you do?', 'Alive', '(left) Save the cub! It’s the right thing to do! | (right) Nothing. There’s not much you can do.', 13, 14, canvas));
...
levels.push(new Level(14, 'res/bg/14.jpg', 'You pretend you don’t see the cub. As you run away, you stumble across a tomb, do you enter?', 'Alive', '(left) Nope. | (right) Of course!', 15, 16, canvas));
...
levels.push(new Level(17, 'res/bg/17.jpg', 'You die. But Juliet wakes up!', 'DEAD', 'So apparently Juliet didn’t really die… and you weren’t really supposed to die either but you’re dead anyways… like you, Juliet decides life is nothing without love and she ACTUALLY takes her life this time. Too bad, maybe you two can live together in another life? Refresh, to try again?', 1, 1, canvas));

levels.push(new Level(18, 'res/bg/18.jpg', 'You wake up and you see some REAL strange things. Cowboys? ... And aliens? What do you do now??', 'DEAD', '(left) FIGHT ‘EM. | (right) Make friends! You can’t take down all of them...', 19, 20, canvas));

levels.push(new Level(19, 'res/bg/19.jpg', 'THE CLAW drops on you before you even make a move!', 'DEAD', 'Oh well, maybe you shouldn’t try fighting a crowd next time? But for now, you can refresh and try again.', 1, 1, canvas));

levels.push(new Level(20, 'res/bg/20.jpg', 'You make friends with them. Great!', 'DEAD', 'Except they’re a little TOO friendly and decides to turn you into a toy, just like them. That’s alright, you can always refresh and try again. Maybe, don’t befriend a bunch of animated toys next time?', 1, 1, canvas));
